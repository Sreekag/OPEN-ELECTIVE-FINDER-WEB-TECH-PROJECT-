    ...
    <div className="container-fluid">
      ...
      <div className="row">
        <div className="col-lg-6 mt-5 ml-5">
          <h4 style={{ textAlign: 'left', color: 'orange' }}><b>WHY DO WE NEED AUTOMOTIVE ENGINEERING?</b></h4><br />
          <h6>
          ...
          <a href="https://www.gvpce.ac.in/syllabi/B.Tech15-16/OE/Electrical%20Safety%20Management15-16.pdf" style={{ textDecoration: 'none', textTransform: 'none', color: 'black' }}>DOWNLOAD SYLLABUS</a>
            ...
            <button className="btn btn-outline-primary mt-5" style={{ borderRadius: '20px' }}>
              <a href="/home" style={{ textDecoration: 'none', textTransform: 'none', color: 'black' }}>BACK</a>
            </button>
          </div>
        </div>
        <div className="col-lg-6">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIbJQQ8q3eQPVmDDNz7Bpt9ghW08fRdOws1A&usqp=CAU" width="470px" height="400px" alt="Remote Sensing" />
        </div>
      </div>
    </div>
  );
