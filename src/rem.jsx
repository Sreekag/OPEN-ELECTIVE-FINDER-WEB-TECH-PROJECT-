    ...
    <div className="container-fluid">
      ...
      <div className="row">
        <div className="col-lg-6 mt-5 ml-5">
          <h4 style={{ textAlign: 'left', color: 'orange' }}><b>WHY DO WE NEED REMOTE SENSING?</b></h4><br />
          <h6>
          ...
          <button className="btn btn-outline-primary mt-5" style={{ borderRadius: '20px' }}>
            ...
            <button className="btn btn-outline-primary mt-5" style={{ borderRadius: '20px' }}>
            <Link to="/home"  style={{ textDecoration: 'none', textTransform: 'none', color: 'black' }}>BACK</Link>
            </button>
          </div>
        </div>
        <div className="col-lg-6">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbNnYc9WP5-5AyjzwHZXsNjSD_9pR0nrR6QQ&usqp=CAU" width="470px" height="400px" alt="Remote Sensing" />
        </div>
      </div>
    </div>
  );
